 ...
 */
static tb_size_t gb_mesh_face_list_itor_size(tb_iterator_ref_t iterator)
{
    // the size
    return gb_mesh_face_list_size((gb_mesh_face_list_ref_t)iterator);
}
static tb_size_t gb_mesh_face_list_itor_head(tb_iterator_ref_t iterator)
{
    // check
    gb_mesh_face_list_impl_t* impl = (gb_mesh_face_list_impl_t*)iterator;
    tb_assert_and_check_return_val(impl, 0);

    // head
    return (tb_size_t)tb_list_entry_head(&impl->head);
}
static tb_size_t gb_mesh_face_list_itor_last(tb_iterator_ref_t iterator)
{
    // check
    gb_mesh_face_list_impl_t* impl = (gb_mesh_face_list_impl_t*)iterator;
    tb_assert_and_check_return_val(impl, 0);
...
static tb_size_t gb_mesh_face_list_itor_tail(tb_iterator_ref_t iterator)
{
    // check
    gb_mesh_face_list_impl_t* impl = (gb_mesh_face_list_impl_t*)iterator;
    tb_assert_and_check_return_val(impl, 0);
...
static tb_size_t gb_mesh_face_list_itor_next(tb_iterator_ref_t iterator, tb_size_t itor)
{
    // check
    gb_mesh_face_list_impl_t* impl = (gb_mesh_face_list_impl_t*)iterator;
    tb_assert_and_check_return_val(impl, 0);
    tb_assert_and_check_return_val(itor, gb_mesh_face_list_itor_tail(iterator));

    // next
    return (tb_size_t)tb_list_entry_next(&impl->head, (tb_list_entry_t*)itor);
}
static tb_size_t gb_mesh_face_list_itor_prev(tb_iterator_ref_t iterator, tb_size_t itor)
{
    // check
    gb_mesh_face_list_impl_t* impl = (gb_mesh_face_list_impl_t*)iterator;
    tb_assert_and_check_return_val(impl, 0);
...
static tb_pointer_t gb_mesh_face_list_itor_item(tb_iterator_ref_t iterator, tb_size_t itor)
{
    // check
    gb_mesh_face_list_impl_t* impl = (gb_mesh_face_list_impl_t*)iterator;
    ...
    // data
    return impl->func.data(&impl->func, (tb_cpointer_t)(((gb_mesh_face_t*)itor) + 1));
}
static tb_void_t gb_mesh_face_list_itor_copy(tb_iterator_ref_t iterator, tb_size_t itor, tb_cpointer_t item)
{
    // check
    gb_mesh_face_list_impl_t* impl = (gb_mesh_face_list_impl_t*)iterator;
    ...
    // copy
    impl->func.copy(&impl->func, (tb_pointer_t)(((gb_mesh_face_t*)itor) + 1), item);
}
static tb_long_t gb_mesh_face_list_itor_comp(tb_iterator_ref_t iterator, tb_cpointer_t ltem, tb_cpointer_t rtem)
{
    // check
    gb_mesh_face_list_impl_t* impl = (gb_mesh_face_list_impl_t*)iterator;
...
static tb_void_t gb_mesh_face_list_item_exit(tb_pointer_t data, tb_cpointer_t priv)
{
    // check
    ...
    // free data
    if (impl->func.free) impl->func.free(&impl->func, (tb_pointer_t)(((gb_mesh_face_t*)data) + 1));
}
...
gb_mesh_face_list_ref_t gb_mesh_face_list_init(tb_size_t grow, tb_item_func_t func)
{
    ...
    do
    {
        ...
        if (!grow) grow = GB_MESH_FACE_LIST_GROW;
        ...
        impl->itor.size = gb_mesh_face_list_itor_size;
        impl->itor.head = gb_mesh_face_list_itor_head;
        impl->itor.last = gb_mesh_face_list_itor_last;
        impl->itor.tail = gb_mesh_face_list_itor_tail;
        impl->itor.prev = gb_mesh_face_list_itor_prev;
        impl->itor.next = gb_mesh_face_list_itor_next;
        impl->itor.item = gb_mesh_face_list_itor_item;
        impl->itor.copy = gb_mesh_face_list_itor_copy;
        impl->itor.comp = gb_mesh_face_list_itor_comp;

        // init pool, item = face + data
        impl->pool = tb_fixed_pool_init(tb_null, grow, sizeof(gb_mesh_face_t) + func.size, tb_null, gb_mesh_face_list_item_exit, (tb_cpointer_t)impl);

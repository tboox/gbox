...
static __tb_inline__ tb_void_t gb_pixmap_argb8888_pixel_cpy_la(tb_pointer_t data, tb_cpointer_t pixel, tb_byte_t alpha)
{
    tb_bits_set_u32_le(data, gb_pixmap_rgb32_blend(tb_bits_get_u32_le(data), tb_bits_get_u32_le(pixel), alpha));
}
static __tb_inline__ tb_void_t gb_pixmap_argb8888_pixel_cpy_ba(tb_pointer_t data, tb_cpointer_t pixel, tb_byte_t alpha)
{
...
static __tb_inline__ tb_void_t gb_pixmap_argb8888_pixels_set_la(tb_pointer_t data, gb_pixel_t pixel, tb_size_t count, tb_byte_t alpha)
{
...
static __tb_inline__ tb_void_t gb_pixmap_argb8888_pixels_set_ba(tb_pointer_t data, gb_pixel_t pixel, tb_size_t count, tb_byte_t alpha)
{
    tb_size_t       l = count & 0x3; count -= l;
    tb_uint32_t*    p = (tb_uint32_t*)data;
    tb_uint32_t*    e = p + count;
...
,   gb_pixmap_argb8888_pixels_set_la
};
...
,   gb_pixmap_argb8888_pixels_set_ba
};

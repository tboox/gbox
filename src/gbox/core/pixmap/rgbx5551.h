...
static __tb_inline__ tb_void_t gb_pixmap_rgbx5551_pixel_cpy_la(tb_pointer_t data, tb_cpointer_t pixel, tb_byte_t alpha)
{
    tb_bits_set_u16_le(data, gb_pixmap_rgbx5551_blend(tb_bits_get_u16_le(data), tb_bits_get_u16_le(pixel), alpha >> 3));
}
static __tb_inline__ tb_void_t gb_pixmap_rgbx5551_pixel_cpy_ba(tb_pointer_t data, tb_cpointer_t pixel, tb_byte_t alpha)
{
    tb_bits_set_u16_be(data, gb_pixmap_rgbx5551_blend(tb_bits_get_u16_be(data), tb_bits_get_u16_be(pixel), alpha >> 3));
}
...
static __tb_inline__ tb_void_t gb_pixmap_rgbx5551_pixels_set_la(tb_pointer_t data, gb_pixel_t pixel, tb_size_t count, tb_byte_t alpha)
{
...
static __tb_inline__ tb_void_t gb_pixmap_rgbx5551_pixels_set_ba(tb_pointer_t data, gb_pixel_t pixel, tb_size_t count, tb_byte_t alpha)
{
    tb_size_t       l = count & 0x3; count -= l; alpha >>= 3;
    tb_uint16_t*    p = (tb_uint16_t*)data;
    tb_uint16_t*    e = p + count;
...
,   gb_pixmap_rgbx5551_pixels_set_la
};
...
,   gb_pixmap_rgbx5551_pixels_set_ba
};

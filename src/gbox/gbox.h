 ...
 * |----------------------------------------------------------------------------------------------------------------------------------------------|
 * | container |      svg             |       path        |                          | glut, x11, sdl, ios, android, mac, windows, fbdev, ...     |
 * | algorithm |      fonts           |       paint       |                          |------------------------------------------------------------|
 * |           |      effects         |       matrix      | skia, opengl, bitmap, ...|               window                 |                     |
 * |           |      animation       |       shader      |                          |          ----------------------------|                     |
 * |           |                      |       bitmap      |                          |  window  |   mouse, keyboard, touch  |         audio       |
 * |           |                      |       clipper     |-------------------------------------|---------------------------|                     |
 * |           |                      |                   |               device                |           events          |                     |
 * |           |                      |                   |-------------------------------------|-------------------------------------------------|
 * |   ...     |       ...            |       ...         |               canvas                |                     application                 |
 * |-----------|----------------------|---------------------------------------------------------|-------------------------------------------------|
 * |    base   |       others ...     |                        core                             |                      platform                   |
 * |----------------------------------------------------------------------------------------------------------------------------------------------|
 * |                                                                -> gbox(graphic)                                                              |
 * |----------------------------------------------------------------------------------------------------------------------------------------------|
 * |                                                                    ubox(ui)                                                                  |
